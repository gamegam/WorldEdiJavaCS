...
$p->sendMessage("/uplau (kor, eng)");
$p->sendMessage("/upa Teleport to the location that has recently been raised");
$p->sendMessage("/upa teleports to a position only in height, so x, z coordinates are not specified!");
return true;
}
if(!is_numeric($args[0])){
